<!--
  barriers/+page.svelte — Barrier Lens flow
  Multi-step reflection: vision → AI barrier analysis → deeper reflection → summary.
  Primary interaction mode based on Gkrimpizi's three-level barrier framework.

  Steps: vision → analysis → reflection → summary
-->
<script>
...
<svelte:head>
  <title>{$t('barriers.title')} — {$t('app.title')}</title>
</svelte:head>
