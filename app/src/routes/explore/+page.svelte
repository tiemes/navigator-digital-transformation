<!--
  explore/+page.svelte — Compass overview.
...
<svelte:head>
  <title>{$t('compass.title')} — {$t('app.title')}</title>
</svelte:head>
...
<style>
  ...
  .dimensions { display: flex; flex-direction: column; gap: 20px; }
  .dimension-header {
